...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public static Timestamp getSystemTime()
	{
		...
		Timestamp times = Timestamp.valueOf(nowTime);
		return times;
	}
	...
	/**
	 * 从当前时间开始第多少个月的这一天的年月日
	 * @param sdate 当前时间
	 * @param m   从当前时间之后的开始第几个月
	 * @return 
	 */
	...
	/**
	 * 年月日栅格化
	 * @param sdate   传入的年月日格式（yyyy/MM/dd、yyyy-MM-dd）
	 * @return
	 */
...
//		System.out.println(dateStr);
		...
		String md=getNextMonthDay("2017-1-01",13);
